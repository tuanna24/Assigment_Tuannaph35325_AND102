package com.example.assigment_tuannaph35325_and102.uliti;
...
public class SendMail {
    private final String username = "tuannaph35325@fpt.edu.vn";
    private final String password = "piwhsjhptoofrbbv";
